...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="file:///G:/HTML/example.html">shopping page</div>
...
<div class="container">
  ...
  <form class="form-inline">
    ...
    <div class="checkbox">
    <b>  <label><input type="checkbox"> Remember me</label> <br>
    </div>
	<input type=" EmailAddress" class="form-control"id=" EmailAddress" placeholder=" Email Address">
